...
namespace HabitAqui.Areas.Identity.Pages.Account.Manage
{
    ...
    public class GestaoLocadoresModel : PageModel
    {
        ...
        public GestaoLocadoresModel(ApplicationDbContext context, UserManager<DetalhesUtilizador> userManager, IUserStore<DetalhesUtilizador> userStore)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync(int currentPage = 1, string sortOrder = "")
        {
